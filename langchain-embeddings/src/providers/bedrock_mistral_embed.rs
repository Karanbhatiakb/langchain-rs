//! Bedrock Mistral embedding provider (stub).
//!
//! Mistral via Amazon Bedrock. This stub returns deterministic size-4 vectors.
...
/// Bedrock Mistral embedding model (providers stub).
///
/// Mistral accessed through Amazon Bedrock.
/// This stub returns deterministic size-4 vectors.
///
/// # Example
/// ```ignore
/// use langchain_embeddings::providers::bedrock_mistral_embed::BedrockMistralEmbeddings;
