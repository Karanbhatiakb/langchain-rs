//! Google Gemini LLM provider — Gemini models via Gemini API.
...
impl GoogleGeminiLLM {
    /// Creates a new `GoogleGeminiLLM` with the given model and API key.
    ...
    pub fn generate(&self, prompt: &str) -> String {
        warn!("GoogleGeminiLLM is a stub — no real API call made");
        format!("[GoogleGeminiLLM stub] received: {}", prompt)
    }
}
...
impl ProviderConfig for GoogleGeminiLLM {
