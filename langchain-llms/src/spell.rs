...
const SPELL_BASE_URL: &str = "https://api.spell.ai/v1";
...
impl SpellLLM {
    pub fn new(model: impl Into<String>, api_key: impl Into<String>) -> Self {
        ...
        Self {
            ...
            temperature: 0.7,
            max_tokens: 1024,
            base_url: SPELL_BASE_URL.to_string(),
...
#[async_trait]
impl BaseLLM for SpellLLM {
    async fn generate(&self, _prompts: &[String], _stop: Option<&[&str]>) -> Result<LLMResult> {
        let text = format!("Spell stub response for model: {}", self.model);
        Ok(LLMResult {
