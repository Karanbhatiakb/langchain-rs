...
impl PostgresChatMemory {
    pub async fn new(
        ...
        let pool = PgPoolOptions::new()
            ...
            .await
            .map_err(|e| ChainError::MemoryError(format!("Failed to connect to PostgreSQL: {}", e)))?;
    ...
    pub async fn get_messages(&self) -> Result<Vec<BaseMessage>> {
        let query = format!(
...
#[async_trait]
impl BaseMemory for PostgresChatMemory {
